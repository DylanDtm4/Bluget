			...
			<section className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
				...
				<div className="space-y-4 mb-6">
					<div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
						...
						<span className="text-sm font-medium text-gray-600 dark:text-gray-200 bg-gray-100 dark:bg-gray-700 px-3 py-1 rounded-full">
					...
					<div className="flex flex-col sm:flex-row gap-3 mb-6">
						...
						<div className="flex-1 text-gray-600 dark:text-gray-300">
							<input
								...
								className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
							/>
						</div>
						...
						<div className="flex items-center gap-2 bg-gray-50 dark:bg-gray-700 rounded-lg p-2 border border-gray-200 dark:border-gray-600">
							...
							<select
								...
								className="text-sm border-0 bg-transparent dark:bg-gray-700 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-0 cursor-pointer font-medium"
							>
