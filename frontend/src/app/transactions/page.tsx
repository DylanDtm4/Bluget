		...
		<div className="max-w-7xl mx-auto px-4 py-6 space-y-10">
			...
			<div className="relative">
				...
				<div className="relative flex justify-center">
					<span
						className="bg-gray-50 dark:bg-black px-4 text-sm text-gray-500 dark:text-gray-300 font-medium"
						id="recurring"
					></span>
				</div>
			</div>
			...
			<section className="bg-blue-50 dark:bg-gray-800 rounded-lg shadow-sm border border-blue-200 dark:border-blue-800 p-6">
				<div className="flex justify-between items-center mb-6">
					<div>
						<h2 className="text-2xl font-semibold text-gray-800 dark:text-white">
							Active Recurring
					...
					<span className="text-sm font-medium text-blue-700 dark:text-blue-400 bg-blue-100 dark:bg-blue-900 px-3 py-1 rounded-full">
